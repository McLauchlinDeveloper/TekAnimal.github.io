...
if(money == "" || money == 0){console.log("We cannot make a site for you at this time.");}
...
if(site == 1) {console.log("We would be happy to make a business site for you.");
} else if(site == 2){
// if user picks personal blog, tell them so
    console.log("We would be happy to make a personal blog for you.");
} else if(site == 3){
// if user picks social media, make sure you know they know
    console.log("We would love to make a social media site for you.");
}
